...
def read_income_entries(
    ...
    for entry in entries:
        e_dict = {
            ...
            "da_amount": entry.da_amount,
            "special_allowance_amount": entry.special_allowance_amount,
            "other_allowances_amount": entry.other_allowances_amount,
            "other_benefits_amount": entry.other_benefits_amount,
            "rent_paid": entry.rent_paid,
            "is_metro": entry.is_metro,
            "hra_exemption": entry.hra_exemption,
...
def update_income_entry(
    *,
    ...
    return {
        ...
        "basic_amount": updated_entry.basic_amount,
        "hra_amount": updated_entry.hra_amount,
        "da_amount": updated_entry.da_amount,
        "special_allowance_amount": updated_entry.special_allowance_amount,
        "other_allowances_amount": updated_entry.other_allowances_amount,
        "other_benefits_amount": updated_entry.other_benefits_amount,
        "rent_paid": updated_entry.rent_paid,
        "is_metro": updated_entry.is_metro,
        "hra_exemption": updated_entry.hra_exemption,
...
def delete_income_entry(
    *,
    ...
    return {
        ...
        "notes": deleted.notes,
        "basic_amount": deleted.basic_amount,
        "hra_amount": deleted.hra_amount,
        "da_amount": deleted.da_amount,
        "special_allowance_amount": deleted.special_allowance_amount,
        "other_allowances_amount": deleted.other_allowances_amount,
        "other_benefits_amount": deleted.other_benefits_amount,
        "rent_paid": deleted.rent_paid,
        "is_metro": deleted.is_metro,
        "hra_exemption": deleted.hra_exemption,

...
class Bond(Base):
    ...
    face_value: Mapped[Decimal] = mapped_column(Numeric, nullable=True)
    coupon_rate: Mapped[Decimal] = mapped_column(Numeric, nullable=True)
    maturity_date: Mapped[date] = mapped_column(Date, nullable=False)
    isin: Mapped[str] = mapped_column(String, nullable=True, index=True)
    payment_frequency: Mapped[PaymentFrequency] = mapped_column(String, nullable=True)
    first_payment_date: Mapped[date] = mapped_column(Date, nullable=True)

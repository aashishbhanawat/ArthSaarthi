...
### Tax Calculations & Limitation of Liability

*   **No Tax Liability or Responsibility:** ArthSaarthi and its developers/contributors are **not responsible or liable** for any inaccuracies, calculation errors, omissions, tax penalties, interest charges, or financial liabilities resulting from the tax calculations, estimations, or reports generated by this application.
*   **Estimations Only:** All tax metrics (including Old vs New Regime comparisons, HRA exemptions, capital gains, and deduction caps) are provided purely as personal planning estimates.
*   **Mandatory Professional Verification:** Users are solely responsible for verifying all financial figures with official tax documents and consulting a qualified Chartered Accountant (CA) or certified tax professional prior to official Income Tax Return (ITR) filing.

### General Limitation of Liability

The developers and contributors of ArthSaarthi shall not be held liable for any financial losses, incorrect data, missed opportunities, tax penalties, or any other damages arising from the use of this application.

    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div
                ...
                className="modal-content w-full max-w-3xl p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl"
            ...
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Coupon</p>
                        <p className="font-semibold dark:text-gray-100">{`${Number(holding.interest_rate || 0).toFixed(2)}%`}</p>
                    </div>
                    <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Maturity</p>
                        <p className="font-semibold dark:text-gray-100">{holding.maturity_date ? formatDate(holding.maturity_date) : 'N/A'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className={`font-semibold ${holding.realized_pnl && holding.realized_pnl >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>

                    ...
                    <div className="card mb-4" data-testid="rd-details-section">
                        ...
                        {isLoadingDetails ? <p className="dark:text-gray-300">Loading...</p> : details && (
                            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm dark:text-gray-300">
                                ...
                                <p className="font-semibold">Account Number:</p><p className="break-words">{details.account_number}</p>
                                <p className="font-semibold">Monthly Installment:</p><p>{formatCurrency(details.monthly_installment)}</p>
                                ...
                                <p className="font-semibold">Tenure:</p><p>{details.tenure_months} months</p>
                                <p className="font-semibold">Maturity Date:</p><p>{formatDate(holding.maturity_date!)}</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="card mb-4">
                        ...
                        {isLoadingDetails ? <p className="dark:text-gray-300">Loading...</p> : details && (
                            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm dark:text-gray-300">
                                ...
                                <p className="font-semibold">Total Invested:</p><p>{formatCurrency(holding.total_invested_amount)}</p>

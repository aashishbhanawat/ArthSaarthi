    ...
    const onSubmit = (data: TransactionFormInputs) => {
        ...
        const mutationOptions = {
            ...
            onError: (error: Error) => {
                ...
                const message = apiError.response?.data?.detail || defaultMessage;
                setApiError(message);
            }
        };
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="flex justify-end space-x-4 pt-4">
                            ...
                            <button
                                ...
                                disabled={isEditMode ? updateTransactionMutation.isPending : createTransactionMutation.isPending || !selectedAsset}
                            >
                                {isEditMode

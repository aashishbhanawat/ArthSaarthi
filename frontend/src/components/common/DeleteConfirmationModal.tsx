    ...
    <div className="modal-overlay" role="dialog" aria-modal="true" data-testid="delete-confirmation-modal">
      <div className="modal-content max-w-md">
        <div className="modal-header">
          ...
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600" disabled={isDeleting}>&times;</button>
        </div>
        <div className="p-6">
          <div className="text-gray-700 mb-4">{message}</div>
          <p className="text-sm text-red-500 bg-red-100 p-3 rounded-md">This action is permanent and cannot be undone.</p>

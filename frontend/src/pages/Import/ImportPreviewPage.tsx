        ...
        return (
            <>
                ...
                <div className="lg:hidden space-y-3">
                    {invalidRows.map((item, index) => (
                        <div key={index} className="card p-4 border-l-4 border-l-error bg-red-50 dark:bg-red-900/10">
                            <div className="flex justify-between items-start mb-2">
                                <span className="badge badge-error badge-xs">Invalid</span>
                                <span className="text-[10px] font-bold text-red-600 dark:text-red-400 uppercase">Error</span>
                            </div>
                            <p className="text-xs font-semibold text-red-700 dark:text-red-300 mb-2">{item.error}</p>
                            <div className="mt-2 pt-2 border-t border-red-100 dark:border-red-800">
                                <span className="text-[10px] text-gray-500 uppercase font-bold block mb-1">Row Data</span>
                                <code className="text-[10px] block bg-white dark:bg-gray-900 p-2 rounded break-all whitespace-pre-wrap text-gray-700 dark:text-gray-300 border border-red-50 dark:border-red-900/50">
        ...
        <div>
            ...
            <div className="space-y-6">
                ...
                {previewData.needs_mapping.length > 0 && (
                    <div className="card p-4 sm:p-6 bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 overflow-hidden">
                ...
                {previewData.invalid.length > 0 && (
                    <div className="card p-4 sm:p-6 bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-700 overflow-hidden">

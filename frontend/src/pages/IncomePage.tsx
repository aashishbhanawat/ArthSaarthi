                    ...
                    <tr key={entry.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-col">
                          ...
                          {Number(entry.hra_exemption || 0) > 0 && (
                            <div className="mt-0.5">
                              <span className="inline-block rounded bg-emerald-100 dark:bg-emerald-900/40 px-1.5 py-0.5 text-[10px] font-bold text-emerald-800 dark:text-emerald-300">
                                Sec 10(13A) HRA Exempt: {formatAmount(Number(entry.hra_exemption))}
                              </span>
                            </div>
                          )}
                        </div>
                  ...
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2 dark:border-slate-700">
                    <div>
                      ...
                      {Number(entry.hra_exemption || 0) > 0 && (
                        <div className="mt-1">
                          <span className="inline-block rounded bg-emerald-100 dark:bg-emerald-900/40 px-1.5 py-0.5 text-[10px] font-bold text-emerald-800 dark:text-emerald-300">
                            HRA Exempt: {formatAmount(Number(entry.hra_exemption))}
                          </span>
                        </div>
                      )}
                    </div>
